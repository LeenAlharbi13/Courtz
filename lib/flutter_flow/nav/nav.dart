...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'log',
          path: '/log',
          builder: (context, params) => const LogWidget(),
        ),
        FFRoute(
          name: 'profile',
          path: '/profile',
        ...
        FFRoute(
          ...
          path: '/courtDetails',
          asyncParams: {
            'courtReceive': getDoc(['Courts'], CourtsRecord.fromSnapshot),
          },
          builder: (context, params) => CourtDetailsWidget(
            courtReceive: params.getParam(
              'courtReceive',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: 'courtView',
          path: '/courtView',
          builder: (context, params) => const CourtViewWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => const CreateAccountCopyWidget(),
        ),
        FFRoute(
          name: 'Login',
          path: '/login',
